...
// code adapted from https://github.com/nikitasnv/vue-resizable
const ELEMENT_MASK = {
...
export default {
  ...
  props: {
    ...
    active: {
      ...
      validator: (val) => ["r", "rb", "b", "lb", "l", "lt", "t", "rt"].filter(
  ...
  mounted() {
    typeof this.width !== "number" && (this.w = "100%");
    typeof this.height !== "number" && (this.h = "100%");
