...
export default {
  ...
  computed: {
    selectedLabels: {
      get() {
        return this.$store.state.project.filters.selectedLabels;
      },
      set(value) {
        this.$store.dispatch("project/filters/selectLabels", value);
      }
    }
  },
  meteor: {
  ...
  methods: {
    ...
    selectLabel(label) {
      this.$store.dispatch("project/filters/selectLabel", label);
    },
