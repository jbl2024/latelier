    ...
    <div v-else class="wrapper">
      ...
      <v-container>
        ...
        <v-col cols="12">
          ...
          >
            <template slot="headline">
              Forces, faits, événements et personnes connues qui influencent le
              projet ?<br>
        ...
        <v-col cols="12">
          ...
          >
            <template slot="headline">
              Quels sont les évenements futurs et incertains qui menaceraient ou
              favoriseraient le projet ?<br>
        ...
        <v-col cols="12" class="bloc">
          ...
          >
            <template slot="headline">
              ...
              Quelle souplesse a-t-on sur le déroulement au regard des dates de
              début et de fin du projet ? <br>
